...
//         console.log("[personal-log] Cadastrado com sucesso")
//         console.log(this)
//     }
...
//         console.log("[personal-log] Aqui estão seus registros")
//         console.log(rows)
//     })
...
//         console.log("[personal-log] Registro deletado com sucesso")
//     })
    
//     // query table data after delete a table data
//     db.all(`SELECT * FROM  places`, function(err, rows) {
//         if (err) {
//             return console.log(err)
//         }
